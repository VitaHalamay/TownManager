...
namespace TownManager.Services.Strategy
{
    public class SparePartsDayStrategy : ISparePartsDayStrategy
    {
        public void RecalculateSparePartsProduction()
        {
            ...
            gameSingleton.Model.Statistics[StatisticsType.SparePartsCount] += companyCount * 450;
        ...
        public void RecalculateDevicesSales()
        {
            ...
            gameSingleton.Model.Statistics[StatisticsType.MoneyCount] += devicesCount * 12;
