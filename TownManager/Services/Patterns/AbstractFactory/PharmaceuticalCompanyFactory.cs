...
{
    public class PharmaceuticalCompanyFactory : IBuildingFactory
    {
        public void Build()
        {
            var gameSingleton = GameSingleton.GetInstance();
            gameSingleton.Model.Buildings.Add(new PharmaceuticalCompany { Type = BuildingType.PharmaceuticalCompany });
